...
const Testimonial = () => {
    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 py-24 bg-[#0f0f1b] text-white'>
            <div className='text-center'>
                <h2 className='text-[42px] font-semibold text-white'>Loved by Creators</h2>
            ...
            <div className='flex flex-wrap mt-10 justify-center'>
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#1b1c2f] shadow-[0_8px_30px_rgba(0,0,0,0.35)] border border-white/10 hover:-translate-y-1 transition duration-300 cursor-pointer'>
